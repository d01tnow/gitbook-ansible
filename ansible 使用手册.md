  ...
  datasource:
    ...
    druid:
      ...
      oracle-datasource:
        ...
        # [A] 数据库用户名配置
        username: nfcos_sptc_iicomm
        # [A] 数据库用户密码配置
        password: Ca16D12cNsfO18g20sZ
      ...
      oracle-datasource-acc:
        ...
        url: jdbc:oracle:thin:@n1.oracle.nfcos:1521:nfcos
        # [A] 数据库用户名配置
        username: nfcos_comm_console
        # [A] 数据库用户密码配置
        password: Fm09Yi03oMh13tSc
        driver-class-name: oracle.jdbc.OracleDriver
        initial-size: 1
        min-idle: 1
        max-active: 3
      ...
      mariadb-datasource-tsm:
        ...
        # [A] 数据库用户密码配置
        username: nfcos_comm_tsm
        password: cOs01Fm18Sh20n52F8
